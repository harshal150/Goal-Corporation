...
const Banks = () => {
  const loanData = [
    ...
    },
    {
      ...
      interestRate: ' on request to 9.65%',
      processingFee: '10k + GST to 0.25% + GST',
      loanAmount: '5 lacs to 15 crore',
    },
    {
