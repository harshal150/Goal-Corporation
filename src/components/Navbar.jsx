...
export const Navbar = () => {
  ...
  return (
    // <nav className="bg-gradient-to-b from-white to-blue-50 z-50  fixed  relative top-0 transition-all duration-300 ease-in-out  ">
    <nav className="bg-gradient-to-b from-white to-blue-50 z-50 sticky top-0 relative shadow-md transition-all duration-300 ease-in-out">
